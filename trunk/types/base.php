...
class fm_controlBase{
	...
	//this function is called in the header; you can place scripts here (like whatever getShowHideCallbackName() returns) validator functions, etc. 
	...
	public function showEditorItem($uniqueName, $itemInfo){
		...
		$str.="<table class=\"editor-item\">".
				...
				"</tr>";	
		$str.="</table>";	
		$str.="<div id=\"{$uniqueName}-edit-div\" style=\"visibility:hidden;position:absolute;\" class=\"editor-item-panel\">".$this->editPanel($uniqueName, $itemInfo)."</div>";
